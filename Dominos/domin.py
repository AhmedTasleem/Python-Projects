...
def login():
    ...
    if c==1:
        ...
        email=input('Enter email: ')
        pnum=list(b.execute('fselect phno from Domuser where email="{email}"'))[0][0]
...
def disp_bill():
    if login_status==True:
        if mode==1:
            ...
            print('Parcal charges of 25Rs. will be included')
            total_amt=25
        elif mode==3:
            print('Parcel charges of 25Rs and Delivery charges 50Rs.included')
            total_amt=75
